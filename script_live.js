const url = 'https://myoni1997.pythonanywhere.com/'
players = null
...
function set_player_html(data, i) {
    ...
    <img class="profile" src='players_pics/${player_id}.jpg' onerror="this.onerror=null;this.src='players_pics/Default.png';" />
    <img class="club" src='clubs/${player_club}.png' onerror="this.onerror=null;this.src='clubs/none.png';" />
...
function set_vs_df(data) {
    ...
    <table class="wipe">
        ...
        <tbody>
            ...
            <tr>
                <td style='color:${set_color(p2_form)};'>${p2_form.toFixed(2)}</td>
                <td style='color:${set_color(p1_form)};'>${p1_form.toFixed(2)}</td>
